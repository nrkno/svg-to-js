 ...
 * @param {[{parser: Function, filename: String, includeBanner?: Boolean}]} [config.extensions] Optional. List of extensions to generate custom outputs
...
export default function svgToJS (config) {
  ...
  [].concat((config.extensions || [])
    ...
    .forEach((extension, index) => {
      ...
      }, extension.includeBanner === true ? banner || '' + '\n' : '')
    }, {})
